...
class UserRequestsController extends Controller
{
    ...
    public function desabilitarConta(Request $request) {
        $request->validate([
            'idAccount' => 'required'
        ]);
        ...
        try {
            ...
            $account = UserInstagram::where('id', $request->idAccount)->where('user_id', $user->id)->first();
            ...
            $data = array(
                'class'   => 'UserRequestsController->desabilitarConta',
                'line'    => $e->getLine(),
                'message' => $e->getMessage()
            );
